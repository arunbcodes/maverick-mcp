...
if TYPE_CHECKING:
    from maverick_agents.state import BacktestingWorkflowState
...
def create_initial_backtest_state(
    ...
    This factory function creates the initial state for the backtest workflow.
    It returns a dictionary that conforms to the BacktestingWorkflowState TypedDict.
    ...
    Args:
        ...
        requested_strategy: Optional user-requested strategy
...
class BacktestingWorkflow:
    ...
    async def run_intelligent_backtest(
        ...
        try:
            ...
            initial_state = create_initial_backtest_state(
                symbol=symbol,
                start_date=start_date,
                end_date=end_date,
                initial_capital=initial_capital,
...
__all__ = ["BacktestingWorkflow", "create_initial_backtest_state"]
