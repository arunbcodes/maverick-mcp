...
def to_datetime(dt: DateLike, tz: str | None = None) -> datetime:
    """
...
def parse_date(date_str: str, format_str: str | None = None) -> datetime:
    """
...
def start_of_day(dt: DateLike, tz: str | None = None) -> datetime:
    """
...
def end_of_day(dt: DateLike, tz: str | None = None) -> datetime:
    """
